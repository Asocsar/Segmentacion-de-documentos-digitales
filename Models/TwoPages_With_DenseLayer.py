...
class Efficient_Bert_OneCall_V2(nn.Module):
    def __init__(self, name, num_features_efficient, feature_concatenation):
        super(Efficient_Bert_OneCall_V2, self).__init__()
        ...
        self.feature_fc = torch.nn.Linear(1280, feature_concatenation)
...
class Efficient_Bert_TwoCall_V2(nn.Module):
    def __init__(self, name, num_features_efficient, feature_concatenation):
        super(Efficient_Bert_TwoCall_V2, self).__init__()
        ...
        self.feature_fc = torch.nn.Linear(2048, feature_concatenation)
        self.output_fc = torch.nn.Linear(feature_concatenation, 1)
